...
def describe_clear():
    ...
    def test_without_force_keeps_servable_files():
        ...
        assert should_clear(time() - 7200) is True  # past duration

    def test_without_force_keeps_files_inside_the_stale_window():
        cache = Cachetta(
            path="cache",
        ...
        assert should_clear(time() - 9000) is True  # past the stale window
